...
import com.bomberman.bomberman.screens.ScreenWin;
...
/**
 * Controller class for ScreenWin, handling user input and screen rendering.
 */

public class ScreenWinController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        this.screenWin = new ScreenWin(this.canvas, this.header);
        this.screenWin.paint();
