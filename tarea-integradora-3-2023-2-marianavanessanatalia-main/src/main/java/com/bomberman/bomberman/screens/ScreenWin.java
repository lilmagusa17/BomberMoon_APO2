...
public class ScreenWin extends BaseScreen {
    ...
    /**
     * Initializes a new instance of the ScreenWin class with the specified main canvas and header canvas.
     *
     * @param canvas The main canvas for the win screen.
     * @param header The canvas for displaying additional information (e.g., lives).
     */
    public ScreenWin(Canvas canvas, Canvas header) {
        super(canvas, header);
        this.canvas = canvas;
        ...
        this.image = new Image(getClass().getResourceAsStream("/com/bomberman/bomberman/img/background/WinScreen.png"));

    }


    /**
     * Paints the content of the ScreenWin.
     */
    @Override
    public void paint() {
