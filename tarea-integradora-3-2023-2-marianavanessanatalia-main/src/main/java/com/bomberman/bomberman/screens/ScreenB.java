...
/**
 * Represents the second screen of the Bomberman game.
 */
public class ScreenB extends BaseScreen{
    ...
    /**
     * Initializes a new instance of the ScreenB class with the specified main canvas and header canvas.
     *
     * @param canvas The main canvas for the game screen.
     * @param header The canvas for displaying additional information (e.g., lives).
     */
    public ScreenB(Canvas canvas, Canvas header){//recibe canvas por inyeccion de dependencia (patron de dise;o, asociacion entre el Screen y Canvas)
        super(canvas, header);
        this.canvas=canvas;
    ...
    /**
     * Checks if the specified element should disappear from the screen.
     *
