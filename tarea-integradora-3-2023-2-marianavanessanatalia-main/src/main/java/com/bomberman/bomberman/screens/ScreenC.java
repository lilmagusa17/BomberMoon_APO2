...
/**
 * Represents the third screen of the Bomberman game.
 */
public class ScreenC extends BaseScreen{
    ...
    /**
     * Initializes a new instance of the ScreenC class with the specified main canvas and header canvas.
     *
     * @param canvas The main canvas for the game screen.
     * @param header The canvas for displaying additional information (e.g., lives).
     */
    public ScreenC(Canvas canvas, Canvas header){//recibe canvas por inyeccion de dependencia (patron de dise;o, asociacion entre el Screen y Canvas)
        super(canvas, header);
        this.canvas=canvas;
        ...
        enemies.add(new Enemy(canvas, new Position(430, 310)));
        enemies.add(new Enemy(canvas, new Position(160, 415)));
    ...
    /**
     * Checks if the enemies are actively pursuing the player, considering obstacles like walls and bricks.
     *
     * @param player The player being chased by the enemies.
     */
    ...
    /**
     * Checks if the specified element should disappear from the game screen.
     *
